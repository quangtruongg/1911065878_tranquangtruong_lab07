using _1911065878_tranquangtruong_lab07.Models;
using System;
...
namespace _1911065878_tranquangtruong_lab07.Controllers
{
    ...
    new sach { Id = 1, Title = "Tôi thấy hoa vàng trên cỏ xanh", 
        AuthorName = "Nguyễn Nhật Ánh", Price = 1, Content="Truyện kể về Tuổi thơ..." },
